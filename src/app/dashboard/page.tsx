...
export default function Page(): React.JSX.Element {
  ...
  return (
    <Grid container spacing={3}>
      ...
      {/* 2. 이탈 고객 수 */}
      <Grid xs={12} sm={6} md={3}>
        <ExpectedChurns value={stats?.expected_churns ?? 0} />
      </Grid>
      ...
      <Grid xs={12} sm={6} md={3}>
        <LoginDays
          ...
          value={stats?.average_days_since_login?.churn ?? 0}
          color="warning"
        />
      </Grid>
      ...
      <Grid xs={12} sm={6} md={3}>
        <LoginDays
          ...
          value={stats?.average_days_since_login?.non_churn ?? 0}
          color="info"
        />
      </Grid>
      ...
      <Grid xs={12} lg={6}>
        <ChurnStatus
          ...
          churned={stats?.expected_churns ?? 0}
        />
      </Grid>
      ...
      <Grid xs={12} sm={6}>
        <AverageWatchTime
          churned={stats?.average_watch_time?.churn ?? 0}
          retained={stats?.average_watch_time?.non_churn ?? 0}
        />
      </Grid>
      ...
      <Grid xs={12} sm={6}>
        <AverageAge
          churned={stats?.average_age?.churn ?? 0}
          retained={stats?.average_age?.non_churn ?? 0}
        />
      </Grid>
      ...
      <Grid xs={12} sm={6}>
        <LoginDaysBarChart
          churned={stats?.average_days_since_login?.churn ?? 0}
          retained={stats?.average_days_since_login?.non_churn ?? 0}
        />
      </Grid>
      ...
      <Grid xs={12}>
        <GenreDistribution
          data={Object.entries(stats?.genre_distribution ?? {}).map(
            ([genre, count]) => ({
              genre,
              count: Number(count),
            })
